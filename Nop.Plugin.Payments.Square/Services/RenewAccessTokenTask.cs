    ...
    public class RenewAccessTokenTask : IScheduleTask
    {
        ...
        public async System.Threading.Tasks.Task ExecuteAsync()
        {
            ...
            try
            {
                ...
                _ = _logger.InformationAsync(await _localizationService.GetResourceAsync("Plugins.Payments.Square.RenewAccessToken.Success"));
            }
            catch (Exception exception)
            {
                //log error on renewing of the access token
                _ = _logger.ErrorAsync(await _localizationService.GetResourceAsync("Plugins.Payments.Square.RenewAccessToken.Error"), exception);
            }
        }
